...
type Phase = 'view' | 'challenge' | 'comparison'
      ...
      <main className="max-w-xl mx-auto px-4 py-6 space-y-6">
        ...
        {data && (
          <>
            ...
            {phase === 'view' && (
              <>
                ...
                <button
                  ...
                  className="block w-full py-3.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-semibold text-sm transition-colors text-center"
                >
                  この問題に挑戦する
                </button>
            ...
            {phase === 'challenge' && (
              <>
                ...
                <button
                  ...
                  className="block w-full py-3 rounded-xl border border-gray-200 dark:border-gray-700
                    text-gray-500 dark:text-gray-400 font-medium text-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-center"
                >
                  戻る
                </button>
              </>
            ...
            {/* ── Phase: comparison ── */}
            {phase === 'comparison' && myResult && (
              <>
                {/* Score comparison */}
                <div className="rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                  <div className="px-4 py-2 bg-gray-50 dark:bg-gray-800 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide text-center">
                    スコア比較
                  </div>
                  <div className="grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-700">
                    <div className="px-4 py-5 flex flex-col items-center gap-2">
                      <span className="text-xs font-semibold text-gray-400 dark:text-gray-500">相手</span>
                      <ScoreBadge score={data.score} />
                    </div>
                    <div className="px-4 py-5 flex flex-col items-center gap-2">
                      <span className="text-xs font-semibold text-blue-500 dark:text-blue-400">あなた</span>
                      <ScoreBadge score={myResult.score} />
                    </div>
                  </div>
                  {/* Win/Lose/Draw banner */}
                  <div className={`px-4 py-2.5 text-center text-sm font-bold ${
                    myResult.score > data.score
                ...
                <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                  ...
                  <div className="divide-y divide-gray-100 dark:divide-gray-800">
                    <div className="px-4 py-3 flex gap-3">
                      <span className="shrink-0 mt-0.5 text-xs font-semibold text-gray-400 dark:text-gray-500 w-16">相手</span>
                      <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{data.userAnswer}</p>
                    </div>
                    <div className="px-4 py-3 flex gap-3">
                      <span className="shrink-0 mt-0.5 text-xs font-semibold text-blue-500 dark:text-blue-400 w-16">あなた</span>
                      <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{myAnswer}</p>
                    </div>
                    <div className="px-4 py-3 flex gap-3 bg-emerald-50/60 dark:bg-emerald-950/30">
                      <span className="shrink-0 mt-0.5 text-xs font-semibold text-emerald-600 dark:text-emerald-400 w-16">模範解答</span>
